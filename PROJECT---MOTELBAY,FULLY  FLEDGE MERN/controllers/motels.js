...
module.exports.createMotel = async (req, res, next) => {
  //  if(!req.body.motel) throw new ExpressError('Invalid Motel Data',400)
//   const geoData = await geocoder.forwardGeocode({
//     query: req.body.motel.location,
//     limit: 1
// }).send()

  const motel = new Motel(req.body.motel);
  // motel.geometry = geoData.body.features[0].geometry;//gives [ longitude,lattitude ]
